# Dodge the Creeps with GDNative Nim

This is a simple game where your character must move
and avoid the enemies for as long as possible, made in GDNative Nim.
...
Language: [GDNative Nim](https://docs.godotengine.org/en/latest/tutorials/scripting/gdnative/index.html)
...
Dependencies:
 * You need [godot-nim](https://github.com/pragmagic/godot-nim).
